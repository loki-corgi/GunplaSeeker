...
const indexListing = async (req, res) => {
    try {
        ...
        const message = req.query.msg || 'Newest 3 listings';
        ...
        res.render('index', { message: message, listings: listings, page: null, hasNextPage: null, hasPreviousPage: null } );

    }
    catch(e) {
        console.error(e);
        //needed because potentially there is nothing to grab
        res.render('index', { message: 'No listing', listings: [], page: null, hasNextPage: null, hasPreviousPage: null });
    }
};
